...
export default function Match({gameData, match, teams}: Props): ReactElement {
    ...
    return <motion.div onTap={() => setShowDetails(!showDetails)} whileHover={{scale: (game1 || game2) ? 1.05 : 1}}>
        ...
        <motion.div initial={'hide'} animate={showDetails ? 'show' : 'hide'} variants={container}>
